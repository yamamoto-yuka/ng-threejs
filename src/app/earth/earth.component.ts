...
export class EarthComponent implements OnInit {
  ...
  // @ViewChild to reference elements from the template side to the component side
  //ElementRef  Module for retrieving element objects
  // @ViewChild('myCanvas', { static: true }) public rendererCanvas!: ElementRef;

  // // Convert to HTMLCanvasElement interface
